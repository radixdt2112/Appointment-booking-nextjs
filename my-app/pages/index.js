...
export default function Home() {
  ...
  const { data: shops } = useQuery('getShops', async () => {
  ...
  return (
    <Layout>
      ...
      <Container >
        ...
        {!shops && <Typography variant="body2" sx={{ my: 3 }}>No Shops are registed</Typography>}
        <Grid container maxWidth="xl" spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
